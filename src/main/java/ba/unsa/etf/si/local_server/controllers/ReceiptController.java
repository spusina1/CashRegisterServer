...
public class ReceiptController {
    ...
    public ResponseEntity<Response> saveOrder(@Valid @RequestBody SellerAppRequest receiptItems){
    ...
    public  ResponseEntity<Response> editOrder(@Valid @RequestBody EditOrderRequest editOrderRequest){
    ...
    public ResponseEntity<Set<GuestOrderResponse>> getGuestOrders() {
    ...
    public ResponseEntity<List<Receipt>> getReceipts(@RequestParam(name = "cash_register_id", required = false) Long cashRegisterId) {
    ...
    public ResponseEntity<Response> saveReceipt(@Valid @RequestBody ReceiptRequest receiptRequest) {
    ...
    public ResponseEntity<Response> reverseReceipt(@PathVariable String id){
    ...
    public ResponseEntity<List<Receipt>> getDailyReceipts(@RequestParam(name = "cash_register_id", required = false) Long cashRegisterId) {
